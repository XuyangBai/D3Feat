...
def deal_with_one_scene(scene, num_keypts):
    ...
    for id1 in range(num_frag):
        for id2 in range(id1 + 1, num_frag):
                ...
                # Choose Top [num_keypts]
                # source_keypts = source_keypts[np.random.choice(len(source_keypts), num_keypts)]
                # target_keypts = target_keypts[np.random.choice(len(source_keypts), num_keypts)]
